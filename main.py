...
model = load_model('model.h5') #model loading
spell = SpellChecker()
...
while True:
    ...
    blured = cv2.erode(blured, None, iterations=2) #remove
    blured = cv2.dilate(blured, None, iterations=2) #add
